...
Data layers are a better solution because they have the people that benefit from the work (frontend teams that want GraphQL) do the work themselves in the way that they need to, while backend engineers can keep exposing the resource-based APIs that they know and love.
