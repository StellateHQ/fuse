...
Fuse.js combines the best tooling from the GraphQL ecosystem to guide you to an organizational and technical “pit of success.” While it uses GraphQL (because it is the best technical choice) and familiarity with GraphQL will make for a minimal learning curve, **you do not need to know GraphQL to get started with Fuse.js.**
...
export const UserNode = node<UserSource>({
  ...
  fields: (t) => ({
    ...
    firstName: t.string({ // Add an additional firstName field
