...
Depending on whether you are querying data from React Server Components, a client component with the app router, or a client component with the pages router, you will need to use a different set of data fetching helpers.
...
## Client components (`/pages` directory)
