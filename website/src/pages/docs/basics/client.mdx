...
Depending on whether you are querying data from [React Server Components](#react-server-components),
a [client component in the app router](#client-components-app-router), or a
[client component in the pages router](#client-components-pages-router), you will need to use a
