...
[Drizzle ORM](https://orm.drizzle.team/docs/overview) is a popular option to access SQL databases in a type-safe way in Node.js. Fetching data from an SQL database with Drizzle in Fuse allows you to avoid having to type any underlying source type.
